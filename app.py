...
#                       {"result":"OK: Participant registered, resend email verification","ifemailexists":true,
#                        "ifemailexists_msg":"message", "ifemailverified":false,"ifemailverified_msg":"message"}
